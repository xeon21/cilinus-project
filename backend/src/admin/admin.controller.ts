...
export class AdminController {
  ...
  @ApiOperation({
    ...
    description: 'Admin only endpoint to register a new user',
  })
  ...
  async registerUser(@Body() registerUserDto: RegisterUserDto) {
    this.logger.log(
      `Registering new user - Request: ${JSON.stringify(registerUserDto)}`,
    );
  ...
  @ApiOperation({
    ...
    description: 'Admin only endpoint to update a user role',
  })
  ...
  @ApiOperation({
    ...
    description: 'Admin only endpoint to change a user password',
  })
  @ApiParam({ name: 'userIdx', type: 'number', description: 'User ID' })
  ...
  async changePasswordByAdmin(
    ...
    this.logger.log(
      `Request payload: ${JSON.stringify({ ...adminChangePasswordDto, newPassword: '[REDACTED]' })}`,
    );
    await this.adminService.changePasswordByAdmin(
      userIdx,
